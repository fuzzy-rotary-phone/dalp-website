...
! function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = g, e.getIn = m, e.set = y, e.setIn = _, e.update = I, e.updateIn = b, e.merge = T, e.mergeDeep = O, e.mergeIn = w, e.omit = A, e.addDefaults = S;
    /*!
     * Timm
     *
    ...
    function mt(t) {
        ...
        r.dispatch((0, m.instanceAdded)((0, a.default)({
            ...
            skipMotion: S,
            skipToValue: n
        }, o))), _t(document.body, "ix2-animation-started", g), f ? function(t, e) {
    ...
    n(130), n(132), n(133), n(134), n(135), n(39), n(137), n(332), n(333), n(334), n(335), n(340), t.exports = n(341)
}, function(t, e, n) {
    "use strict";
    var r = n(3);
        ...
        switch (n.actionTypeId) {
            ...
            case st:
                var I = n.config,
                    ...
                    w = I.aValue;
                return {
                    rValue: b, gValue: T, bValue: O, aValue: w
                };
            case it:
                    ...
                    switch (r.actionTypeId) {
                        ...
                        case st:
                            var h = pt[r.actionTypeId],
                                ...
                                y = n.aValue;
                            Pt(t, h, o), a(t, h, y >= 1 ? "rgb(".concat(E, ",").concat(g, ",").concat(m, ")") : "rgba(".concat(E, ",").concat(g, ",").concat(m, ",").concat(y, ")"));
                            break;
                        default:
                            var _ = r.config.unit,
                                I = void 0 === _ ? "" : _;
    ...
    function _t(t) {
        ...
        var R, N, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[b || O] || {},
        ...
        return null == N || null == C ? [] : m.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : R === k ? d(N, C) : R === G ? p(d(N)).filter(E(C)) : R === X ? h(d(N)).filter(E(C)) : d(C)
    }
    var It = /px/,
        bt = function(t, e) {
        ...
        function _(e, n) {
            ...
            i.done = a.find("> .w-form-done"), i.fail = a.find("> .w-form-fail"), i.fileUploads = a.find(".w-file-upload"), i.fileUploads.each(function(e) {
                ! function(e, n) {
                    ...
                    if (l.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), h.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), g) f.on("click", function(t) {
                        t.preventDefault()
                        ...
                        h.on("click keydown", function(t) {
                            ...
                            (r = i.target && i.target.files && i.target.files[0]) && (o.toggle(!1), s.toggle(!1), a.toggle(!0), a.focus(), E.text(r.name), S() || b(n), n.fileUploads[e].uploading = !0, function(e, n) {
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), m.test(s) ? i.handler = A : s || (o ? i.handler = w : y())
        }
    ...
    r.define("slider", t.exports = function(t, e) {
        ...
        function D(e, n) {
            ...
            var l = e.offsetX || 0,
                ...
                T = "opacity " + I + "ms " + _,
                O = "transform " + I + "ms " + _;
            if (v.find(a).removeAttr("tabindex"), v.removeAttr("aria-hidden"), v.find("*").removeAttr("aria-hidden"), E.find(a).attr("tabindex", "-1"), E.attr("aria-hidden", "true"), E.find("*").attr("aria-hidden", "true"), u || (v.each(g.intro), E.each(g.outro)), n.immediate && !m) return f(v).set(p), void S();
            if (e.index !== e.previous) {
                if (u || e.ariaLiveLabel.text("Slide ".concat(o + 1, " of ").concat(i.length, ".")), "cross" === y) {
                    var w = Math.round(I - I * r.crossOver),
                        A = Math.round(I - w);
                    return T = "opacity " + w + "ms " + _, f(h).set({
                        visibility: ""
                    }).add(T).start({
                        opacity: 0
                    }), void f(v).set({
...
Webflow.require('ix2').init({
    "events": {
        "e-341": {
            ...
            "target": {
                "id": "0d0e2b38-896a-da99-fb7a-beb425c5b919",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-343": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "0d0e2b38-896a-da99-fb7a-beb425c5b920",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-345": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "0d0e2b38-896a-da99-fb7a-beb425c5b927",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-347": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "0d0e2b38-896a-da99-fb7a-beb425c5b92e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-583": {
            ...
            "createdOn": 1670096198329
        }
    },
    "actionLists": {
        "a": {
            "id": "a",
            "title": "Collapse Item (Reveal)",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-n-3",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".body-text-m",
                            "selectorGuids": ["fac7f4f7-af82-5591-251f-3494c1181bd0"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".headline.s",
                            "selectorGuids": ["640c2bd9-9411-6b33-7ef8-aa408261bfac", "4b975e7f-ff8b-ea61-ef34-8838ee0f1a44"]
                        },
                        "globalSwatchId": "0a6b3edc",
                        "rValue": 66,
                        "bValue": 134,
                        "gValue": 28,
                        "aValue": 1
        ...
        "a-17": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "638f33c9df26a4df3fb723d6|d007f9e3-4fec-2f43-7f29-d9bdb0578609"
                        },
                        "yValue": 88,
                        "xUnit": "PX",
                        "yUnit": "px",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1670092391087
        },
        "a-18": {
            "id": "a-18",
            "title": "Footer Reveal (Home)",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-18-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "638f33c9df26a4df3fb723d6|3da1432d-5401-1728-896c-649e52145a1e"
                        },
                        "yValue": 44,
                        "xUnit": "PX",
                        "yUnit": "px",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1670092980699
        },
        "a-19": {
            "id": "a-19",
            "title": "Page Zoom (Home)",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-19-n",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "638f33c9df26a4df3fb723d6|740b7dc0-958b-8c58-38ac-e8be8ae235c0"
                        },
                        "xValue": 1.075,
                        "yValue": 1.075,
                        "locked": true
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1670093189178
        },
        "a-20": {
            "id": "a-20",
            "title": "Header Reveal (Home)",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-20-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "638f33c9df26a4df3fb723d6|eebc2960-ecea-2873-74ae-19dbd1ddb3e3"
                        },
                        "yValue": 44,
                        "xUnit": "PX",
                        "yUnit": "px",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1670093466549
        },
        "a-21": {
            "id": "a-21",
            "title": "Wireframes Reveal",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-21-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "638f33c9df26a4df3fb723d6|7d67e71b-3f89-0076-b432-abe3bcabc025"
                        },
                        "xValue": -500,
                        "xUnit": "px",
                        "yUnit": "PX",
